...
contract FixedProductMarketMakerFactory {
    ...
    mapping(address => bytes32) public addresstoquestionId;
    ...
    function createFixedProductMarketMaker(
        ...
        addresstoquestionId[address(newFpmm)] = _questionId;
    ...
    function getQuestionIdByAddress(address _address)
    public
    view
    returns(bytes32)
    {
        return addresstoquestionId[_address];
    }
}
